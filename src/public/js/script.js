(function(d,w){
    ...
    d.addEventListener('DOMContentLoaded', function(){
        ...
        DownloadContent = d.getElementById('downloadContent');
        ...
        d.addEventListener('click', event => {
            ...
            if (evt.matches('[name=theme-item]')) {
                d.getElementsByName('theme-item').forEach(
        ...
        SendButton.addEventListener('click', async event => {
            try {
                ...
                DownloadContent.classList.remove('actived')
                ...
                if (convert.ok) {
                    ...
                    if (convert.url){
                        ...
                        DownloadContent.innerHTML = `
                            <a id="DownloadLink" href="${BASE_URL}/download?filename=${convert.url}" class="button-download">
                                Descargar Zip
                            </a>
                        `;
                        DownloadContent.classList.add('actived')
                    }
                    FileStash = []
                    RenderFileList()
    ...
    function handleLoader(action){
        let loader_ = d.getElementById('_loader');
        if (action === 'open') {
            loader_.classList.add('show')
            return;
        }
        if (action === 'close') {
            loader_.classList.remove('show')
            return;
        }
    }
